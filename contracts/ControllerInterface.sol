...
contract ControllerStorage {
    ...
    //useless
    LVXTokenDistribution public LVXTokenDistribution;
    //token0=>token1=>pair
...
interface ControllerInterface {
    ...
    function setLevex(address _Levex) external;
    ...
    function setLVXWethDexData(bytes memory _LVXWethDexData) external;
