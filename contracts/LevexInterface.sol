...
abstract contract LevexStorage {
    ...
    struct CalculateConfig {
        ...
        uint128 feesDiscountThreshold; //  30 * (10 ** 18) minimal holding of xlvx to enjoy fees discount
...
/**
  * @title LevexInterface
  * @author Levexerage
  */
interface LevexInterface {
