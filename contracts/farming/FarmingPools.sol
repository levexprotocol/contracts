...
/// @title Farming Pools
/// @author Levex
/// @notice Deposit LVX to earn inerest
...
contract FarmingPools is Adminable {
    ...
    constructor(address _LVXToken, address payable _admin)
    {
        LVXToken = IERC20(_LVXToken);
        admin = _admin;
    }
    ...
    function getReward(address stakeToken) public updateReward(stakeToken, msg.sender) checkStart(stakeToken) {
        ...
        if (reward > 0) {
            ...
            LVXToken.safeTransfer(msg.sender, reward);
