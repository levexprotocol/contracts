...
//   consLVX.log("starting create pair ", await token0.name(), '-', await token1.name())
...
//   consLVX.log("finished create pair ", await token0.name(), '-', await token1.name(), ",tx=", transaction.tx);
//   return router;
// }
